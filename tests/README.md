...
to bring up a local testing environment
2. `$ cd postgresql9-ext-postgis/tests/provisioning/site-testing-local`
3. `$ vagrant up`
4. `$ cd ..`
...
1. `$ cd postgresql9-ext-postgis/tests/provisioning`
...
Results for these tests can be found [here](https://semaphoreci.com/bas-ansible-roles-collection/postgresql9-ext-postgis).
